...
package {
	 ...
	 */
	[SWF(width=640, height=480, backgroundColor=0xFFFFFF, frameRate=30, scriptTimeLimit=15)]
	public class BarnBuddyExperiment extends Sprite {
		
		public function BarnBuddyExperiment() {
			if (stage){
				_init();
			} 
			else { 
		...
		private function _initGame():void {
			...
			var barnBuddy:BarnBuddy;
			new Navigation("BarnBuddy");
		}
	}
}