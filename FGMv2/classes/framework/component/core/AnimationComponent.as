	...
	*/
	public class AnimationComponent extends GraphicComponent {
		...
		protected function initAnimComponent($animComponent:AnimationComponent, $graphic:*):AnimationComponent {
			...
			$animComponent.registerPropertyReference("bitmapRender");
			$animComponent.registerPropertyReference("bitmapAnim",{callback:$animComponent.onAnim});
			//$animComponent.registerPropertyReference("mouseInput",{onMouseRollOver:$animComponent.onMouseRollOver, onMouseRollOut:$animComponent.onMouseRollOut/*, onMouseDown:$animComponent.onMouseDown, onMouseUp:$animComponent.onMouseUp*/});
