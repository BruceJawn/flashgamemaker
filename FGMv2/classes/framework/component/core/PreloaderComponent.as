	...
	*/
	public class PreloaderComponent extends GraphicComponent {
		...
		private function _initListener():void {
			FlashGameMaker.stage.addEventListener(Event.ENTER_FRAME,onLoading);
		}
		//------ Register Property  ------------------------------------
		...
		public function onLoading($evt:Event):void {
			var loaded:Number = FlashGameMaker.stage.loaderInfo.bytesLoaded;
			var total:Number = FlashGameMaker.stage.loaderInfo.bytesTotal;
		...
		private function onLoadingComplete():void {
			FlashGameMaker.stage.removeEventListener(Event.ENTER_FRAME,onLoading);
