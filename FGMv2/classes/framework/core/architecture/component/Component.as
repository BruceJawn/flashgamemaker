...
package framework.core.architecture.component{
	...
	*/
	public dynamic class Component extends Sprite {
		...
		protected var _propertyReferences:Array = null;
		...
		public function Component($componentName:String, $entity:IEntity, $singleton:Boolean=false, $prop:Object=null) {
			...
			_initVar($componentName, $entity, $singleton);
		}
		//------ Init Var ------------------------------------
		private function _initVar($componentName:String, $entity:IEntity,  $singleton:Boolean):void {
			_componentName = $componentName;
			_entity = $entity;
			_properties = new Dictionary();	
			_propertyReferences = new Array();
		...
		public function registerProperty($propertyName:String):void {
			...
			_properties[$propertyName] = new Vector.<Component>;
		}
		//------- Remove Property -------------------------------
		...
		//After registering EntityManager callback ths function to populate properties with existent registered component to the property
		public function addPropertyComponents($propertyName:String, $components:Vector.<Component>):void {
			if($components){
		...
		public function actualizePropertyComponent($propertyName:String, $component:Component):void {
		}
		...
		public function registerPropertyReference($propertyName:String):void {
			_entity.entityManager.registerPropertyReference($propertyName,this);
			_propertyReferences.push($propertyName);
		}
		...
		public function unregisterPropertyReference($propertyName:String):void {
			...
			_propertyReferences.splice(propertyIndex,1);
		}
