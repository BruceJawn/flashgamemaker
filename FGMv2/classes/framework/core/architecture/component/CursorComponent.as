	...
	*/
	public class CursorComponent extends GraphicComponent {
		...
		public override function initProperty():void {
			super.initProperty();
			registerPropertyReference("mouseInput", {isListeningMouse:true,onMouseMove:onMouseMove,onMouseDown:onMouseDown,onMouseUp:onMouseUp});
		}
		//------ Remove Listener ------------------------------------
		...
		//------ On Mouse Move ------------------------------------
		public function onMouseMove($evt:*):void {
			if(_cursor!=null){
