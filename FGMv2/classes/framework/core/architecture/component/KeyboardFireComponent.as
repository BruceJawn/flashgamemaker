...
package framework.core.architecture.component{
	...
	*/
	public class KeyboardFireComponent extends GraphicComponent {
		...
		public function KeyboardFireComponent($componentName:String, $entity:IEntity, $singleton:Boolean = true, $prop:Object = null) {
		...
		public override function actualizeComponent(componentName:String, componentOwner:String, component:Component):void {
			...
			if (_timer_count>=_timer_delay||! _timer_on) {
				if (componentName==_componentName) {
					...
					fire(component as PlayerComponent);
				} 
			}
		}
		//------- Check Attack -------------------------------
		...
		private function createBullet(component:PlayerComponent):void {
			/*if(graphic!=null){
				...
				bullet.graphics.beginBitmapFill(graphic.bitmapData);
