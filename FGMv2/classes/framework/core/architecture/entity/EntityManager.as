...
package framework.core.architecture.entity{
	...
	public class EntityManager implements IEntityManager {
		...
		public function addComponentFromName($entityName:String,$componentName:String,$newName:String, $prop:Object=null, $singleton:Boolean=false):Component {
		...
		public function registerPropertyReference($propertyName:String, $component:Component, $param:Object=null):void {
			...
			if (property==null) {
				...
				if(_properties[$propertyName].register){
					_properties[$propertyName].register.actualizePropertyComponent($propertyName, $component, $param);
				}
			}			
		}
