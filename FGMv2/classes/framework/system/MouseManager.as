	...
	*/
	public class MouseManager implements IMouseManager {
		...
		private function initVar():void {
			FlashGameMaker.stage.addEventListener(FocusEvent.FOCUS_OUT,onLoseFocus,false,0,true);
		}
		//------ Mouse Pixel Color ------------------------------------
		public static function get MousePixelColor():uint {
			var bitmapData:BitmapData = new BitmapData(FlashGameMaker.width, FlashGameMaker.height,true,0);
			bitmapData.draw(FlashGameMaker.clip);
			var pixel:uint = bitmapData.getPixel32(FlashGameMaker.clip.mouseX, FlashGameMaker.clip.mouseY);
			return pixel;
		}
		//------ Mouse Pixel Color ------------------------------------
