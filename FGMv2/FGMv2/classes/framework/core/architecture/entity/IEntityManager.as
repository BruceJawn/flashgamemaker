...
package framework.core.architecture.entity{
	...
	public interface IEntityManager{
		 ...
		 */
		function addComponentFromName($entityName:String,$componentName:String,$newName:String, $singleton:Boolean=false, $prop:Object=null):Component;
		/**
		 * Remove Component
		 */
		 ...
		 */
		function getComponentFromFamily($family:Class):Vector.<Component>;
		/**
		 * Register Property
		 */
		 ...
		 */
		function registerPropertyReference($propertyName:String, $component:Component):void;
		/**
