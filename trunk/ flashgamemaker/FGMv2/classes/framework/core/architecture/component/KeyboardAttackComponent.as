...
package framework.core.architecture.component{
	...
	*/
	public class KeyboardAttackComponent extends Component {
		...
		public function KeyboardAttackComponent($componentName:String, $entity:IEntity, $singleton:Boolean = false, $prop:Object = null) {
		...
		public override function initProperty():void {
			...
			registerProperty("keyboardAttack");
		}
		...
		public override function actualizeComponent(componentName:String, componentOwner:String, component:Component):void {
			if (componentName==_componentName&&_keyboard_gamePad!=null) {
				...
				addPlayer(component as PlayerComponent);
			}
		}
		//------- Check Attack -------------------------------
		private function checkAttack():void {
			/*if (_keyboard_gamePad.fire1.isDown) {
				var componentWithProperty:Array = entity.getComponentsWithPropertyName("health");
				for each (var playerAttacking:PlayerComponent in _players) {
					for each (var obj:Object in componentWithProperty) {
						...
						var playerHit:PlayerComponent = entity.getComponent(componentName) as PlayerComponent;
