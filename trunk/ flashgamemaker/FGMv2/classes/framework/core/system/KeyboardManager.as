	...
	*/
	public class KeyboardManager extends EventDispatcher implements IKeyboardManager {
		...
		public function initListener():void {
			FlashGameMaker.clip.addEventListener(KeyboardEvent.KEY_DOWN, onKeyDown);
			FlashGameMaker.clip.addEventListener(KeyboardEvent.KEY_UP, onKeyUp);
		}
		//------ Remove Listener ------------------------------------
		public function removeListener():void {
			FlashGameMaker.clip.removeEventListener(KeyboardEvent.KEY_DOWN, onKeyDown);
			FlashGameMaker.clip.removeEventListener(KeyboardEvent.KEY_UP, onKeyUp);
		}
		//------- To String  -------------------------------
