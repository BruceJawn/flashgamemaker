	...
	*/
	public class MouseManager extends EventDispatcher implements IMouseManager {
		...
		public function initListener():void {
			FlashGameMaker.clip.addEventListener(MouseEvent.CLICK, onClick);
			FlashGameMaker.clip.addEventListener(MouseEvent.MOUSE_DOWN, onMouseDown);
			FlashGameMaker.clip.addEventListener(MouseEvent.MOUSE_UP, onMouseUp);
			FlashGameMaker.clip.addEventListener(MouseEvent.MOUSE_MOVE, onMouseMove);
			FlashGameMaker.clip.addEventListener(MouseEvent.MOUSE_WHEEL, onMouseMove);
		}
		//------ Remove Listener ------------------------------------
		public function removeListener():void {
			FlashGameMaker.clip.removeEventListener(MouseEvent.CLICK, onClick);
			FlashGameMaker.clip.removeEventListener(MouseEvent.MOUSE_DOWN, onMouseDown);
			FlashGameMaker.clip.removeEventListener(MouseEvent.MOUSE_UP, onMouseUp);
			FlashGameMaker.clip.removeEventListener(MouseEvent.MOUSE_MOVE, onMouseMove);
			FlashGameMaker.clip.removeEventListener(MouseEvent.MOUSE_WHEEL, onMouseMove);
		}
		//------ On Click ------------------------------------
