...
package framework.core.architecture.entity{
	...
	public class Entity implements IEntity {
		...
		public function Entity($entityName:String, $entityManager:IEntityManager){
			_initVar($entityName,$entityManager);
		}
		//------ Init Var ------------------------------------
		private function _initVar($entityName:String, $entityManager:IEntityManager):void {
		...
		public function removeComponent($component:Component):void {
			...
			_entityManager.removeComponent($component);
