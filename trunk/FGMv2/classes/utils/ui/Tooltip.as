	...
	public class Tooltip {
		...
		public static function CreateTooltip($displayObject:DisplayObject,$color:uint,$alpha:Number=1,$filters:Array=null, $reference:DisplayObject=null):MovieClip{
			...
			if($reference){
				...
				tooltip.x = FlashGameMaker.clip.mouseX - tooltip.width/2;
				tooltip.y = FlashGameMaker.clip.mouseY - tooltip.height/2 -40;
			}
			LayoutUtil.CheckBorder(tooltip);
			FlashGameMaker.AddChild(tooltip); 
			return tooltip;
		}
		...
		public static function RemoveTooltip():void{
			if(tooltip && FlashGameMaker.clip.contains(tooltip)){
				FlashGameMaker.RemoveChild(tooltip);
			}
		}
