...
package script.game.littleFighterEvo{
	...
	public class Preloader extends State implements IState{
		...
		private function initComponent():void {
			var renderComponent:RenderComponent = _entityManager.addComponentFromName("LittleFighterEvo","RenderComponent","myRenderComponent") as RenderComponent;
		...
		private function getAssetsToLoad():Array {
			...
			for each(var bg:Object in Data.BACKGROUND){
				assetsToLoad.push(bg.path);
			}
			for each(var object:Object in Data.OBJECT){
				assetsToLoad.push(object.data);
				assetsToLoad = assetsToLoad.concat(object.graphics);
			}
			assetsToLoad.push("../assets/LittleFighterEvo/main.mp3");
			assetsToLoad.push("../assets/LittleFighterEvo/stage1.mp3");
			return assetsToLoad;
		}
		//------ On Loading Complete ------------------------------------
