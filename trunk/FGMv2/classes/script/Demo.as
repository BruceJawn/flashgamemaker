package script{
	...
	public class Demo {
		...
		public function Demo() {
			...
			//EntityFactory.createScrollingBitmap("ScrollingBitmap","../assets/nuage.jpg", 0, 30, 250, new Point(1,0));
			...
			//EntityFactory.createAnimation("Animation", "../assets/Panda.swf", 50,50);
			EntityFactory.createAnimations("Animation");
