...
package framework.add.screen{
	...
	*/
	public class ConfigScreen extends InterfaceScreen {

		private var _returnBt:SimpleButton=null;
		private var _cancelBt:SimpleButton=null;

		public function ConfigScreen(name:String,clip:MovieClip) {
			super(name,clip);
			initVar();
			initListener();
		}
		...
		private function initVar():void {
			...
			_cancelBt=_clip.returnBt;
			_cancelBt.focusRect=false;
			_cancelBt.tabIndex=2;
		}
		//------ Init Listener ------------------------------------
		private function initListener( ):void {
			_returnBt.addEventListener(MouseEvent.CLICK,onReturnClick);
			_cancelBt.addEventListener(MouseEvent.CLICK,onCancelClick);
