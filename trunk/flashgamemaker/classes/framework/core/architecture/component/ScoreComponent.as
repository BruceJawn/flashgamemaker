...
package framework.core.architecture.component{
	...
	*/
	public class ScoreComponent extends GraphicComponent {
		...
		public function ScoreComponent(componentName:String, componentOwner:IEntity) {
		...
		private function createScore():void {
			if (_source!=null) {
				var myBitmapData:BitmapData=new BitmapData(_source.width/10*_score_digit,_source.height,true,0);
				for (var i:int=0;i<_score_digit;i++){
					myBitmapData.copyPixels(_source.bitmapData, new Rectangle(i*_source.width/10,0,_source.width/10 ,_source.height), new Point(0, 0),null,null,true);
				}
