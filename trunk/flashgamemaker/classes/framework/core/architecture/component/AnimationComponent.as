...
package framework.core.architecture.component{
	...
	*/
	public class AnimationComponent extends Component {
		...
		public override function actualizeComponent(componentName:String,componentOwner:String,component:*):void {
			if(_timer_count>=_timer_delay){
				if(componentName!=_componentName && component._keyboard_key!=null){
					...
					frame = setAnimation(frame,graphic_numFrame,graphic_numFrame,spatial_isMoving,keyboard_key,animation);
		...
		//----- Set Animation -----------------------------------
		private function setAnimation(graphic_frame:int,graphic_oldFrame:int,graphic_numFrame:int,spatial_isMoving:Boolean,keyboard_key:Object,animation:Dictionary):int {
			var doubleClick:String=keyboard_key.doubleClick;
			var longClick:String=keyboard_key.longClick;
			var keyTouch:String=keyboard_key.keyTouch;
			if (spatial_isMoving && doubleClick  && animation["RUN"]!= null && graphic_frame<animation["RUN"]*graphic_numFrame*graphic_numFrame) {
					graphic_frame+=animation["RUN"]*graphic_numFrame*graphic_numFrame;
			}else if (spatial_isMoving &&animation["WALK"]!= null && graphic_frame<animation["WALK"]*graphic_numFrame*graphic_numFrame) {
					graphic_frame+=animation["WALK"]*graphic_numFrame*graphic_numFrame;
			}else if (!spatial_isMoving && animation["ATTACK"]!= null && keyTouch=="ATTACK" && graphic_frame<animation["ATTACK"]*graphic_numFrame*graphic_numFrame) {
				    graphic_frame+=graphic_numFrame*graphic_numFrame;
			}else if (!spatial_isMoving &&animation["STATIC"]!= null && graphic_frame>graphic_numFrame*graphic_numFrame) {
				    graphic_frame-=graphic_numFrame*graphic_numFrame;
			}
			return graphic_frame;
		}
