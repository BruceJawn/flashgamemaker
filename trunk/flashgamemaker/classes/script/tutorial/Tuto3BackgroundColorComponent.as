...
package script.tutorial{
	...
	*/
	...
	public class Tuto3BackgroundColorComponent {

		public function Tuto3BackgroundColorComponent() {
			...
			//After having called the backgroundColorComponent, the function changeColor permits
			//o define the color or the background. The parameter is a hexadecimal color (hexa RGB)in String
			var backgroundColorComponent:BackgroundColorComponent =entityManager. addComponent("Entity","BackgroundColorComponent","myBackgroundColorComponent");
			backgroundColorComponent.changeColor("FF0000");//FF0000 is red
		}
	}
}