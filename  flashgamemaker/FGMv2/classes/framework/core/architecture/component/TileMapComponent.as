...
package framework.core.architecture.component{
	...
	*/
	public class TileMapComponent extends GraphicComponent {
		...
		public function TileMapComponent($componentName:String, $entity:IEntity, $singleton:Boolean = false, $prop:Object = null) {
...
//			_physicManager.setMap(map);
	...
	/*		if (tile==null) {
			...
			if (! _tileMap_world[tileName]) {
				...
				_tileMap_world[tileName]=FlashGameMaker.AddChild(this,clip);
			} else {
		...
		public function removeTile(k:int,j:int,i:int):void {
			...
			if (_tileMap_world[tileName]) {
				FlashGameMaker.RemoveChild(this,_tileMap_world[tileName]);
