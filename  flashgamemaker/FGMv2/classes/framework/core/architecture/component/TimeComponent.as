...
package framework.core.architecture.component{
	...
	*/
	public class TimeComponent extends GraphicComponent {
		...
		public function TimeComponent($componentName:String, $entity:IEntity, $singleton:Boolean=true, $prop:Object = null) {
...
//			dispatcher.addEventListener(TimerEvent.TIMER, _onTick);
		}
		//------ Remove Listener ------------------------------------
		private function _removeListener():void {
//			var dispatcher:EventDispatcher = _timeManager.getDispatcher();
//			dispatcher.removeEventListener(TimerEvent.TIMER, _onTick);
		}
		//------ On Tick ------------------------------------
